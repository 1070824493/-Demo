...
- (CGRect)popMenuViewFrame
{
    ...
    CGFloat menuViewY = self.startPoint.y - self.menuItems.count * 20-5;
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextMoveToPoint(contextRef, self.startPoint.x + self.menuWidth - 10, self.startPoint.y-5);
    CGContextAddLineToPoint(contextRef, self.startPoint.x + self.menuWidth - 10 * 2, self.startPoint.y-5);
    CGContextAddLineToPoint(contextRef, self.startPoint.x + self.menuWidth - 10 * 1.5, self.startPoint.y - 10);
    // 结束绘制
